  ...
  var _loop = function _loop(i) {
    accoItem[i].addEventListener('click', function (e) {
      ...
      if (accoItem[i].classList.contains('acco-menu__item--active')) {
        ...
        for (var _i = 0; _i < accoItem.length; _i++) {
          accoItem[_i].classList.remove('acco-menu__item--active');
        }
  ...
  var _loop2 = function _loop2(i) {
    memberCard[i].addEventListener('click', function (e) {
      ...
      if (memberCard[i].classList.contains('member__card--active')) {
        ...
        for (var _i2 = 0; _i2 < memberCard.length; _i2++) {
          memberCard[_i2].classList.remove('member__card--active');
        }
...
(function () {
  ...
  document.querySelector('#resetButton').addEventListener('click', function () {
    for (var _i3 = 0; _i3 < requiredItems.length; _i3++) {
      requiredItems[_i3].classList.remove('required--active');
    }
  });
})();
...
(function () {
  ...
  for (var i = 0; i < buttonRead.length; i++) {
    _loop5(i);
  }
